    ...
    <div class="flex flex-col sm:flex-row h-screen">
        ...
        <div class="p-10 flex-1 overflow-y-auto">
            ...
            <div class="overflow-x-auto">
                <h1 class="text-3xl font-semibold block mb-4">Wallets</h1>
                <table class="table-auto w-full bg-white shadow-xl">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT w.*, u.full_name, u.email, u.mobile 
                                FROM `wallet` w 
                                LEFT JOIN `users` u ON w.userId = u.id";
                        $query = mysqli_query($conn, $sql);
                        $counter = 1; // Initialize counter
                        while ($rows = mysqli_fetch_assoc($query)) {
                            $userID = $counter; // Use counter for ID
                            ...
                            <tr class="border-b border-gray-200">
                                <td class="px-4 py-4 whitespace-nowrap"><?= $userID ?></td>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap"><?= $balance ?></td>
                                <td class="px-4 py-4 whitespace-nowrap"><?= $created_at ?></td>
                            </tr>
                            <?php
